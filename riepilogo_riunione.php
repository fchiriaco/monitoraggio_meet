...
if(!isset($_POST["codice_riunione"]) || empty(trim($_POST["codice_riunione"])))
	$datiok = false;


if(!isset($_POST["datariunione"]) || empty(trim($_POST["datariunione"])))
	$datiok = false;
...
$codice_riunione = str_replace("-","",filter_var($_POST["codice_riunione"],FILTER_SANITIZE_STRING));
$data_riunione = filter_var($_POST["datariunione"],FILTER_SANITIZE_STRING);
